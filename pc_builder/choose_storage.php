            ...
            <div class="col-10 mt-3">
                <table class="table table-hover mb-0" style="background-color: #fff">
                    ...
                    <tbody>
                        ...
                        $result = $mysqli->query("
                        SELECT
                        s.id_storage, CONCAT(m.manufacturer_name,' ',s.storage_name) as nazwa, s.storage_capacity as capacity, sff.storage_form_factor_name as form, st.storage_type_name as type, s.storage_price as price
                        FROM 
                        `storage` s, `manufacturer` m, `storage_type` st, `storage_form_factor` sff
                        WHERE 
                        s.manufacturer_id_manufacturer=m.id_manufacturer AND s.storage_type_id_storage_type=st.id_storage_type AND s.storage_form_factor_id_storage_form_factor=sff.id_storage_form_factor;
                        ");
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr>
                                ...
                                echo 
                                $row['form']." ".$row['type']."</td>
                                <form action=\"php/scripts/sc_add_storage_build.php\" method=\"POST\">
                                <td>
